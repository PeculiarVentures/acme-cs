...
namespace PeculiarVentures.ACME.Server.Services
{
    ...
    {
        public OrderService(IOrderRepository orderRepository, IAuthorizationService authorizationService, IOptions<ServerOptions> options)
        {
        ...
        public IOrder EnrollCertificate(int accountId, int orderId, FinalizeOrder @params)
        {
            ...
            Task
                .Run(async () =>
                {
                    ...
                    var cert = OrderRepository.CreateCertificate(certificate);
        ...
        {
            // TODO Use Certificate Service
            return OrderRepository.Items
                .Where(o =>
                    o.Certificate != null
                    && o.Certificate.Thumbprint.Equals(thumbprint, StringComparison.CurrentCultureIgnoreCase))
                .Select(o => o.Certificate)
                .ToArray();
        }
    }
}
