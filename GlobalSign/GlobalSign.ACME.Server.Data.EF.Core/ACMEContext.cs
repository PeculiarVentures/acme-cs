...
namespace GlobalSign.ACME.Server.Data.EF.Core
{
    public class GsAcmeContext : DbContext
    {
        public GsAcmeContext(DbContextOptions<GsAcmeContext> options)
            : base(options)
        {
        ...
        public DbSet<GsOrder> Orders { get; set; }
