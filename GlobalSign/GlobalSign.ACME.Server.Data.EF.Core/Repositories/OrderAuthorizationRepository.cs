...
{
    public class GsOrderAuthorizationRepository : GsBaseRepository<IOrderAuthorization, OrderAuthorization>, IOrderAuthorizationRepository
    {
        public GsOrderAuthorizationRepository(GsAcmeContext context) : base(context)
        {
        }
